...
const developer = {
  ...
  focus: [
    ...
    "Full-Stack Web Systems (TypeScript & Next.js)",
  ],
  stack: {
    ai_engineering: ["AI Agents", "Agent Loops", "RAG", "n8n", "OpenRouter"],
    frontend:       ["Next.js", "React", "TypeScript", "Tailwind CSS", "shadcn/ui"],
    backend:        ["TypeScript", "Node.js", "Hono", "REST APIs", "Prisma ORM"],
    database:       ["PostgreSQL", "Supabase", "SQLite"],
    devops_infra:   ["Docker", "Linux", "Nginx", "Coolify", "VPS", "PM2"],
  },
  principles: [
    "AI as core product architecture",
    "Auditable context & grounded responses (RAG)",
    "Clean code, maintainable systems & measurable performance",
    "Production-ready deployment & automated workflows",
  ],
} as const;
```
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/RAG_Pipelines-007ACC?style=for-the-badge&logo=chainlink&logoColor=white" />
  ...
  <img src="https://img.shields.io/badge/Agent_Loops-10B981?style=for-the-badge" />
</p>

### **Frontend & User Interface**
<img src="https://skillicons.dev/icons?i=react,nextjs,ts,vite,tailwind,html,css" />

### **Backend & Data**
<img src="https://skillicons.dev/icons?i=nodejs,ts,express,prisma,postgres,supabase,sqlite" />
...
* **Software Developer** @ **Quick / Fibra** *(Ago 2024 – Feb 2025)*
  ...
  * Desenvolvimento do site oficial do Volta Redonda Futebol Clube.
